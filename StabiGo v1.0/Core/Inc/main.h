...
#define OLED_IIC_DC_Pin GPIO_PIN_15
#define OLED_IIC_DC_GPIO_Port GPIOA
#define OLED_IIC_RES_Pin GPIO_PIN_10
#define OLED_IIC_RES_GPIO_Port GPIOC
#define OLED_IIC_SDA_Pin GPIO_PIN_11
#define OLED_IIC_SDA_GPIO_Port GPIOC
#define OLED_IIC_SCL_Pin GPIO_PIN_12
#define OLED_IIC_SCL_GPIO_Port GPIOC
